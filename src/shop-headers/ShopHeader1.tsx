...
const ShopHeader1 = ({ wr }: { wr: Wr }) => {
    ...
    const sortOptions = useMemo(() => {
        const base = [
            { key: "newest", label: "New Arrivals", sortBy: "createdAt", sortDirection: "desc", type: "date" },
     ...
     */
    const handleSortChange = (e: any, option: WrSortOption) => {
        e.preventDefault();
        e.stopPropagation();
